...
function Marquee({
    ...
    return (
        <div {...props} ref={containerRef} className={cn("group flex overflow-hidden p-2 [--gap:2rem] gap-(--gap)" + (vertical ? " flex-col" : " flex-row"), className)} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
            <div ref={contentRef} className={cn("flex shrink-0 justify-around gap-(--gap)" + (vertical ? " flex-col" : " flex-row"))}>
